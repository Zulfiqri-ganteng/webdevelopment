...
<div class="dashboard-container fade-in">
    ...
    <div class="dashboard-header glass-card">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1><i class="fas fa-book mr-2"></i>Data Mata Pelajaran</h1>
                <p>Kelola kurikulum dan mata pelajaran sekolah dengan mudah</p>
            </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-number" id="activeMapel">0</div>
            <div class="stat-label">Mapel Aktif</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right mt-2 mt-md-0">
                <div class="btn-group" role="group">
                    ...
                    <button type="button" class="btn btn-outline-primary">Nonaktif</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card">
        <div class="card-header-modern d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <h3 class="card-title mb-1 text-dark" style="font-weight: 700;">
                    <i class="fas fa-list-alt text-primary mr-2"></i>Daftar Mata Pelajaran
                </h3>
                <p class="text-muted mb-0">Kelola semua mata pelajaran dalam kurikulum</p>
            </div>
            <div class="mt-2 mt-md-0">
                <div class="text-muted">
                    <i class="fas fa-sync-alt me-1"></i> Terakhir diperbarui: <span id="lastUpdate"><?= date('d M Y H:i') ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="tableMapel" class="table table-modern w-100">
                    <thead>
                        <tr>
...
<div class="modal fade modal-glass" id="modalForm" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="formMapel" autocomplete="off" class="form-modern">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-book me-2"></i> <span id="modalTitle">Tambah Mata Pelajaran</span>
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold text-dark">Kode Mapel <span class="text-danger">*</span></label>
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_mapel" id="kode_mapel" class="form-control border-left-0"
                                placeholder="Contoh: MTK10, BIN12" required>
                        </div>
                        <small class="form-text text-muted">Kode unik untuk mata pelajaran (max 10 karakter)</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama_mapel" id="nama_mapel" class="form-control border-left-0"
        ...
        $(function() {
            ...
            const table = $('#tableMapel').DataTable({
                ...
                language: {
                    ...
                    info: "Menampilkan _START_ hingga _END_ dari _TOTAL_ mata pelajaran",
                ...
                createdRow: function(row, data) {
                    ...
                    const headers = ['No', 'Kode Mapel', 'Nama Mata Pelajaran', 'Status', 'Aksi'];
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'kode_mapel',
                        className: 'text-center',
                        render: d => `<span class="kode-badge">${d}</span>`
                    },
                    {
                        data: 'nama_mapel',
                    ...
                    },
                    {
                        ...
                        className: 'text-center',
                        render: d => `
                            <span class="badge badge-success bg-success p-2 rounded-pill">
                    ...
                    },
                    {
                        ...
                        <div class="action-group">
                            <button class="btn btn-info btn-action edit" data-id="${d.id}" title="Edit">
                ...
                initComplete: function() {
                    ...
                    try {
                        ...
                        $('#totalMapel').text(data.length);
                        $('#activeMapel').text(data.length); // Asumsi semua aktif
                        // Hitung rata-rata mapel per guru (contoh sederhana)
                        $('#avgMapel').text(data.length > 0 ? (data.length / 10).toFixed(1) : '0');
                    } catch (error) {
            ...
            $('#tableMapel').on('click', '.edit', function() {
                ...
                $.get(base + '/get/' + id, res => {
                    if (res) {
                        ...
                        Swal.fire('Error', 'Data mata pelajaran tidak ditemukan', 'error');
                    }
                }).fail(() => {
                    Swal.fire('Error', 'Gagal memuat data mata pelajaran', 'error');
                });
            ...
            $('#tableMapel').on('click', '.del', function() {
                ...
                Swal.fire({
                    ...
                    text: 'Data mata pelajaran akan dihapus permanen dan tidak dapat dikembalikan!',
                    icon: 'warning',
